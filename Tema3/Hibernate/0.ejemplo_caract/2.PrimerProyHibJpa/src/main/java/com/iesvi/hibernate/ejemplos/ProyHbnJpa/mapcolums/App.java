package com.iesvi.hibernate.ejemplos.ProyHbnJpa.mapcolums;
...
/**
 * Proyecto JPA con Hibernate
 */
public class App {
	public static void main(String[] args) {
		
		//Configuramos el EMF a través de la unidad de persistencia
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("ProyectoHibernateJPA");
