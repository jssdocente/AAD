...
public class EjemploDaoEmpleados {
	...
	private static void listarUnEmpleado(DaoEmpleados dao) {
		System.out.println("Busqueda de un empleado");
		...
		if (e != null) {
			...
			System.out.println("No existe ningun registro con ese ID");
		}
	...
	private static void nuevoEmpleado(DaoEmpleados dao) {
		System.out.println("Insercion de un nuevo empleado");
	...
	private static void eliminarUnEmpleado(DaoEmpleados dao) {
		...
		System.out.println("¿Esta usted seguro de eliminar dicho registro? (S/N)");
